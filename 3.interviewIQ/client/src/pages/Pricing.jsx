  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6'>
      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
        ...
        {/* In your pricing page, you just wrote plans.map((plan) =>). You ignored the index because your plan already had a unique ID (plan.id) that you could use later. */}
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {!plan.default &&
                <button
                // this disabled condn is to prevent multiple clicks by user 
